...
<div class="container hidden-xs logo">
        <a href="${createLink(controller: "page", action: "homePage")}"><img class="img-responsive" src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/logos/logo.png" alt="/logos/logo.png" /></a>
                        ...
                        <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#">Menu</a>
                            <ul class="dropdown-menu">
                                <g:each in="['juice', 'smothi', 'oil','rawfood']" var="category">
                                    <li><span class="pull-right"><i class="fa fa-angle-right"></i></span><g:link controller="page" action="menuPage">${category}</g:link>
                                    </li>
                                </g:each>
                            </ul>
                        </li>
