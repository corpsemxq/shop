	...
	<header>
        ...
        <div>
            <form>
                ...
                US Text:  <input type="number" name="phonenumber">
			...
			<div class="container">
				<nav class="navbar navbar-static-top">
					<div class="navbar-header">
						<a class="navbar-brand visible-xs" href="index.gsp"><img class="img-responsive" src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/logos/logo-xs.png" alt="/logos/logo-xs.png" />
						</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3">
					<h1>Our Chef</h1>
					<p class="text-center animated fadeInLeft">Proin at cursus mi. Donec euismod lectus vel lacus luctus sollicitudin. Duis pulvinar magna nunc, eget lobortis eros auctor id.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-6 section-content animatedParent animateOnce">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/chef.jpg" class="img-responsive  animated fadeIn" alt="chef.jpg">
				</div>
		...
		<div class="container">
			...
			<div class="portfolio grid-4">
				<figure class="animateOnScroll" data-animation="fadeIn">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/portfolio/1.jpg" alt="portfolio/1.jpg" />
					<figcaption>
				...
				<figure class="animateOnScroll" data-animation="fadeIn">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/portfolio/2.jpg" alt="portfolio/2.jpg" />
					<figcaption>
						<h2>Portfolio Item</h2>
						<p>Dis-moi ce que tu manges, je te dirai ce que tu es</p>
						<a href="portfolio-item.html">View more</a>
				...
				<figure class="animateOnScroll" data-animation="fadeIn">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/portfolio/3.jpg" alt="" />
					<figcaption>
						<h2>Portfolio Item</h2>
						<p>Dis-moi ce que tu manges, je te dirai ce que tu es</p>
						<a href="portfolio-item.html">View more</a>
				...
				<figure class="animateOnScroll" data-animation="fadeIn">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/portfolio/4.jpg" alt="" />
					<figcaption>
						<h2>Portfolio Item</h2>
						<p>Dis-moi ce que tu manges, je te dirai ce que tu es</p>
						<a href="portfolio-item.html">View more</a>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 section-content">
					<img src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-103717042850/img/Website+Image/place.jpg" class="img-responsive" alt="place.jpg">
				</div>
			</div>
